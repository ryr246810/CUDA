...
const Standard_GUID& OCAF_IPeriodShape::GetID() {
  static Standard_GUID anID("22D22E83-C69A-11d4-8F1A-0060B0EE18E8");
  return anID;
}


//=======================================================================
//function : MakePeriodShape
//purpose  : Adds a line object to the document
//=======================================================================
Handle(TDataStd_TreeNode) 
OCAF_IPeriodShape::
MakePeriodShape_FunctionNode( const Handle(TDataStd_TreeNode)& theNode,
			      ...
			      TCollection_ExtendedString& theError)
{
  ...
  aFunctionInterface.SetName("PeriodShape function");
...
Standard_Boolean 
OCAF_IPeriodShape::
MakePeriodShape_Execute( TCollection_ExtendedString& theError )
{
  if( myTreeNode.IsNull()) {
    theError = NOTDONE;
    return Standard_False;
  }
  // 5. setup a TFunction_Function's driver "aDriver" from OCAF_PeriodShapeDriver
  OCAF_PeriodShapeDriver aDriver;
...
//=======================================================================
OCAF_IPeriodShape::
OCAF_IPeriodShape(const Handle(TDataStd_TreeNode)& aTreeNode)

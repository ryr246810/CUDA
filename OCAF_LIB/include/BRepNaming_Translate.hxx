...
#ifndef _BRepNaming_Translate_HeaderFile
#define _BRepNaming_Translate_HeaderFile
...
class BRepNaming_Translate  : public BRepNaming_TopNaming {
...
public:
  ...
  // Methods PUBLIC
  // 
  Standard_EXPORT BRepNaming_Translate();
  Standard_EXPORT BRepNaming_Translate(const TDF_Label& ResultLabel);

...
#ifndef _BRepNaming_Parabola_HeaderFile
#define _BRepNaming_Parabola_HeaderFile
...
class BRepNaming_Parabola  : public BRepNaming_TopNaming {
...
//      }
 // Methods PUBLIC
 // 
Standard_EXPORT BRepNaming_Parabola();
Standard_EXPORT BRepNaming_Parabola(const TDF_Label& ResultLabel);

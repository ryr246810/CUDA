...
#ifndef _BRepNaming_Shell_HeaderFile
#define _BRepNaming_Shell_HeaderFile
...
class BRepNaming_Shell  : public BRepNaming_TopNaming {
...
public:
  ...
  // Methods PUBLIC
  // 
  Standard_EXPORT BRepNaming_Shell();
  Standard_EXPORT BRepNaming_Shell(const TDF_Label& ResultLabel);
  Standard_EXPORT   void Init(const TDF_Label& ResultLabel) ;
  Standard_EXPORT   void Load(TopoDS_Shell& aShell, const BRepNaming_TypeOfPrimitive3D TypeOfResult) const;

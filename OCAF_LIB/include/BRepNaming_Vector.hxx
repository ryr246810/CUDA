...
#ifndef _BRepNaming_Vector_HeaderFile
#define _BRepNaming_Vector_HeaderFile
...
class BRepNaming_Vector  : public BRepNaming_TopNaming {
...
public:
  ...
  // Methods PUBLIC
  // 
  Standard_EXPORT BRepNaming_Vector();
  Standard_EXPORT BRepNaming_Vector(const TDF_Label& ResultLabel);

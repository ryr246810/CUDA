...
const Standard_GUID& OCAF_IMirror::GetID() {
  static Standard_GUID anID("22D22E66-C69A-11d4-8F1A-0060B0EE18E8");
  return anID;
}
...
//=======================================================================
Handle(TDataStd_TreeNode) OCAF_IMirror::MakeMirror_FunctionNode( const Handle(TDataStd_TreeNode)& theNode,
								 ...
								 TCollection_ExtendedString& theError)
{
  ...
  aFunctionInterface.SetName("Mirror function");
...
//purpose  : Adds a line object to the document
//=======================================================================
Standard_Boolean OCAF_IMirror::MakeMirror_Execute( TCollection_ExtendedString& theError )
{
  if( myTreeNode.IsNull()) {
    theError = NOTDONE;
    return Standard_False;
  }
  // 5. setup a TFunction_Function's driver "aDriver" from OCAF_MirrorDriver
  OCAF_MirrorDriver aDriver;
...
//purpose  :
//=======================================================================
OCAF_IMirror::OCAF_IMirror(const Handle(TDataStd_TreeNode)& aTreeNode)
...
//=======================================================================
void OCAF_IMirror::SetMoveAttach(Standard_Boolean theType)
{
...
//=======================================================================
Standard_Boolean OCAF_IMirror::GetMoveAttach() 
{
  TDF_Label L = GetEntry().FindChild(ARGUMENTS_TAG);
  Handle(TDataStd_Integer) anInt;  
  TDF_Label aLabel = L.FindChild(TRANSLATE_ARG_MOVE);
...
//=======================================================================
void OCAF_IMirror::SetCopyMode(Standard_Boolean theType)
{
  TDF_Label L = GetEntry().FindChild(ARGUMENTS_TAG);
  Handle(TDataStd_Integer) anInt;
  Standard_Integer aType = theType ? 1 : 0;
...
//=======================================================================
Standard_Boolean OCAF_IMirror::GetCopyMode() 
{
  TDF_Label L = GetEntry().FindChild(ARGUMENTS_TAG);
  Handle(TDataStd_Integer) anInt;  
  TDF_Label aLabel = L.FindChild(TRANSLATE_ARG_COPYMODE);

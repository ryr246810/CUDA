...
#ifndef _BRepNaming_Arc_HeaderFile
#define _BRepNaming_Arc_HeaderFile
...
class BRepNaming_Arc  : public BRepNaming_TopNaming {
...
//      }
 // Methods PUBLIC
 // 
Standard_EXPORT BRepNaming_Arc();
Standard_EXPORT BRepNaming_Arc(const TDF_Label& ResultLabel);

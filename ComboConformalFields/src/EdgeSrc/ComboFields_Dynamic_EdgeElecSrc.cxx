...
ComboFields_Dynamic_EdgeElecSrc::ComboFields_Dynamic_EdgeElecSrc()
  :ComboFields_Dynamic_SrcBase()
{
}


ComboFields_Dynamic_EdgeElecSrc::ComboFields_Dynamic_EdgeElecSrc(const FieldsDefineCntr* theCntr, PhysDataDefineRule theRule)
...
void ComboFields_Dynamic_EdgeElecSrc::SetupRgn()
{
...
void ComboFields_Dynamic_EdgeElecSrc::Setup()
{
  m_Datas.clear();
...
void ComboFields_Dynamic_EdgeElecSrc::Advance()
{

...
#ifndef _BRepNaming_RecPeriodEdge_HeaderFile
#define _BRepNaming_RecPeriodEdge_HeaderFile
...
class BRepNaming_RecPeriodEdge  : public BRepNaming_TopNaming {
...
public:
  ...
  // Methods PUBLIC
  // 
  Standard_EXPORT BRepNaming_RecPeriodEdge();
  Standard_EXPORT BRepNaming_RecPeriodEdge(const TDF_Label& ResultLabel);

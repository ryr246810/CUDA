...
const Standard_GUID& OCAF_ICylinder::GetID() {
  static Standard_GUID anID("22D22E54-C69A-11d4-8F1A-0060B0EE18E8");
  return anID;
}
...
//=======================================================================
Handle(TDataStd_TreeNode) OCAF_ICylinder::MakeCylinder_FunctionNode( const Handle(TDataStd_TreeNode)& anObjectNode,
								     ...
								     TCollection_ExtendedString& theError)
{
  ...
  /*
  OCAF_ICylinder ICylinder(aFunctionNode);
  ICylinder.SetName("Cylinder function");
  ICylinder.SetType(theType);  
  */

  OCAF_IFunction aFunctionInterface(aFunctionNode);
  aFunctionInterface.SetName("Cylinder function");
...
//purpose  : Adds a line object to the document
//=======================================================================
Standard_Boolean OCAF_ICylinder::MakeCylinder_Execute( TCollection_ExtendedString& theError )
{
  if( myTreeNode.IsNull()) {
    theError = NOTDONE;
    return Standard_False;
  }
  // 5. setup a TFunction_Function's driver "aDriver" from OCAF_CylinderDriver
  OCAF_CylinderDriver aDriver;
...
OCAF_ICylinder::OCAF_ICylinder(const Handle(TDataStd_TreeNode)& aTreeNode)

...
Node *Parser::ParseRegion(Parser::size_type start, Parser::size_type end)
{
    ...
    if(multiexpr)
    {
        unique_ptr<Node> n(new MultiNode(m_expr));
    ...
    {
        // Assignment next
        unique_ptr<Node> n(new AssignNode(m_expr));
    ...
    else if(addsubindex != (size_type)-1)
    {
        ...
        {
            // Addition
            unique_ptr<Node> n(new AddNode(m_expr));
        ...
        {
            // Subtraction
            unique_ptr<Node> n(new SubtractNode(m_expr));
            n->Parse(*this, start, end, addsubindex);
            return n.release();
        }
    }
    else if(muldivindex != (size_type)-1)
    {
        ...
        {
            // Multiplication
            unique_ptr<Node> n(new MultiplyNode(m_expr));
        ...
        {
            // Division
            unique_ptr<Node> n(new DivideNode(m_expr));
            n->Parse(*this, start, end, muldivindex);
            return n.release();
        }
    }
    else if(posnegindex == start)
    {
        ...
        {
            unique_ptr<Node> n(new NegateNode(m_expr));
    ...
    {
        // Exponent
        unique_ptr<Node> n(new ExponentNode(m_expr));
    ...
    else if(fgopen == start + 1)
    {
        ...
        if(fgclose == end)
        {
            ...
            unique_ptr<FunctionNode> n(flist->Create(ident, m_expr));
    ...
    else if(start == end)
    {
        ...
        {
            // Variable/constant
            unique_ptr<Node> n(new VariableNode(m_expr));
            n->Parse(*this, start, end);
            return n.release();    
        }
        else
        {
            // Value
            unique_ptr<Node> n(new ValueNode(m_expr));
            n->Parse(*this, start, end);
            return n.release();
        }
    }

...
const Standard_GUID& OCAF_IVertex::GetID() {
  static Standard_GUID anID("22D22E10-C69A-11d4-8F1A-0060B0EE18E8");
  return anID;
}
...
//=======================================================================
Handle(TDataStd_TreeNode) OCAF_IVertex::MakeVertex_FunctionNode( const Handle(TDataStd_TreeNode)& anObjectNode,
								 ...
								 TCollection_ExtendedString& theError)
{
  ...
  aFunctionInterface.SetName("Vertex function");
  aFunctionInterface.SetType(theType);  

  /*
  OCAF_IVertex IVertex(aFunctionNode);
  IVertex.SetName("Vertex function");
  IVertex.SetType(theType);  
  */
...
//purpose  : Adds a point object to the document
//=======================================================================
Standard_Boolean OCAF_IVertex::MakeVertex_Execute( TCollection_ExtendedString& theError )
{
  if( myTreeNode.IsNull()) {
    theError = NOTDONE;
    return Standard_False;
  }
  // 5. setup a TFunction_Function's driver "aDriver" from OCAF_VertexDriver
  OCAF_VertexDriver aDriver;
...
//purpose  :
//=======================================================================
OCAF_IVertex::OCAF_IVertex(const Handle(TDataStd_TreeNode)& aTreeNode):OCAF_IFunction(aTreeNode)
{

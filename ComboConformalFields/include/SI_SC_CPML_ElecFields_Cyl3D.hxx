#ifndef _SI_SC_CPML_ElecFields_Cyl3D_HeaderFile
#define _SI_SC_CPML_ElecFields_Cyl3D_HeaderFile

#include <SI_SC_ElecFields_Cyl3D.hxx>


class SI_SC_CPML_ElecFields_Cyl3D : public SI_SC_ElecFields_Cyl3D
{
public:
  SI_SC_CPML_ElecFields_Cyl3D();
  SI_SC_CPML_ElecFields_Cyl3D(const FieldsDefineCntr* theCntr);
  virtual ~SI_SC_CPML_ElecFields_Cyl3D();

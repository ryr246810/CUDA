...
#ifndef _BRepNaming_MultiCut_HeaderFile
#define _BRepNaming_MultiCut_HeaderFile
...
class BRepNaming_MultiCut  : public BRepNaming_TopNaming {
...
public:
  ...
  // Methods PUBLIC
  // 
  Standard_EXPORT BRepNaming_MultiCut();
  Standard_EXPORT BRepNaming_MultiCut(const TDF_Label& ResultLabel);

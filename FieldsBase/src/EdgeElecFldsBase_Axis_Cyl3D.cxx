...
EdgeElecFldsBase_Axis_Cyl3D::EdgeElecFldsBase_Axis_Cyl3D()
  :FieldsBase()
{
}


EdgeElecFldsBase_Axis_Cyl3D::EdgeElecFldsBase_Axis_Cyl3D(const FieldsDefineCntr* theCntr, PhysDataDefineRule theRule)
  :FieldsBase(theCntr, theRule)
{
}


EdgeElecFldsBase_Axis_Cyl3D::EdgeElecFldsBase_Axis_Cyl3D(const FieldsDefineCntr* theCntr)
  :FieldsBase(theCntr)
{
}
...
void EdgeElecFldsBase_Axis_Cyl3D::Setup()
{
  FieldsBase::Setup();
  ...
  switch(m_Rule)
    ...
    case EXCLUDING:
      {
	GetGridGeom_Cyl3D()->GetAllGridEdgeDatasNotOfMaterialTypesAlongAxis(m_Materials, m_Datas);
    ...
    case INCLUDING:
      {
	GetGridGeom_Cyl3D()->GetAllGridEdgeDatasOfMaterialTypesAlongAxis(m_Materials, m_Datas);
#ifdef ELECFLDSBASE_DBG
    ...
    case NORULE:
      {
	GetGridGeom_Cyl3D()->GetAllGridEdgeDatasAlongAxis(m_Datas);
	break;
      }
    }
}
...
bool EdgeElecFldsBase_Axis_Cyl3D::IsPhysDataMemoryLocated() const
{
  bool result = true;

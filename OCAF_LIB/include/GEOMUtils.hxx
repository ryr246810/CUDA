...
namespace GEOMUtils
{
  ...
  TopoDS_Shape RemoveExtraEdges(const TopoDS_Shape &theShape);
  void FixShapeAfterBooleanOperation(TopoDS_Shape &aResult);
  void FixShapeAndRemoveExtraEdgesAfterBooleanOperation(TopoDS_Shape &aResult);
  void CheckSI(TopoDS_Shape& aShape);
  void FixShapes(TopoDS_Shape& theInputShape);

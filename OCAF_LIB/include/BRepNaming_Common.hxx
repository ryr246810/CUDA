...
#ifndef _BRepNaming_Common_HeaderFile
#define _BRepNaming_Common_HeaderFile
...
class BRepNaming_Common  : public BRepNaming_BooleanOperationFeat 
{
...
public:
  ...
  // Methods PUBLIC
  // 
  Standard_EXPORT BRepNaming_Common();
  Standard_EXPORT BRepNaming_Common(const TDF_Label& ResultLabel);

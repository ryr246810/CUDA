...
#ifndef _BRepNaming_Ellipse_HeaderFile
#define _BRepNaming_Ellipse_HeaderFile
...
class BRepNaming_Ellipse  : public BRepNaming_TopNaming {
...
//      }
 // Methods PUBLIC
 // 
Standard_EXPORT BRepNaming_Ellipse();
Standard_EXPORT BRepNaming_Ellipse(const TDF_Label& ResultLabel);

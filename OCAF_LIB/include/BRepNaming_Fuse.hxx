...
#ifndef _BRepNaming_Fuse_HeaderFile
#define _BRepNaming_Fuse_HeaderFile
...
class BRepNaming_Fuse  : public BRepNaming_BooleanOperationFeat 
{
...
public:
  ...
  // Methods PUBLIC
  // 
  Standard_EXPORT BRepNaming_Fuse();
  Standard_EXPORT BRepNaming_Fuse(const TDF_Label& ResultLabel);

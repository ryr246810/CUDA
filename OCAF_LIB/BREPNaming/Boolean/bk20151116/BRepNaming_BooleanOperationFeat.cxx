...
void BRepNaming_BooleanOperationFeat::LoadResult(BRepAlgoAPI_BooleanOperation& MS) const {
  ...
  if (listShapeRes.Extent() == 1) {
    ...
    cout<<"listShapeRes.Extent()\t=\t"<<listShapeRes.Extent()<<endl;
  }
  //*/

  /*
  if(!GEOMUtils::CheckAndFix(aResult)){
    cout<<"BRepNaming_BooleanOperationFeat::LoadResult----------------------Can not be Fixed---------------error"<<endl;
  }
  //*/

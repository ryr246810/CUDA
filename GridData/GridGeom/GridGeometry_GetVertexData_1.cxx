					      ...
					      vector<GridVertexData*>&  theDatas) const
{
  ...
  GetGridVertexDatasOfMaterialTypesOfSubRgn( theMaterials,subRgn,isExcludingAxis,theDatas);
}
...
void 
GridGeometry::
GetGridVertexDatasOfMaterialTypesOfSubRgn(const set<Standard_Integer>& theMaterials,
					  const TxSlab2D<Standard_Integer>& subRgn,
					  const bool isExcludingAxis, 
					  vector<GridVertexData*> & theDatas) const
{

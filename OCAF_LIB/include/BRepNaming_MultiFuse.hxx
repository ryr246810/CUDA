...
#ifndef _BRepNaming_MultiFuse_HeaderFile
#define _BRepNaming_MultiFuse_HeaderFile
...
class BRepNaming_MultiFuse  : public BRepNaming_TopNaming {
...
public:
  ...
  // Methods PUBLIC
  // 
  Standard_EXPORT BRepNaming_MultiFuse();
  Standard_EXPORT BRepNaming_MultiFuse(const TDF_Label& ResultLabel);

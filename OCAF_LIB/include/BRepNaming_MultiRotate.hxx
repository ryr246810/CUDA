...
#ifndef _BRepNaming_MultiRotate_HeaderFile
#define _BRepNaming_MultiRotate_HeaderFile
...
class BRepNaming_MultiRotate  : public BRepNaming_TopNaming {
...
public:
  ...
  // Methods PUBLIC
  // 
  Standard_EXPORT BRepNaming_MultiRotate();
  Standard_EXPORT BRepNaming_MultiRotate(const TDF_Label& ResultLabel);

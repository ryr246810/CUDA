...
ExprException::~ExprException() throw()
{
}

ExprException::Type ExprException::GetType() const
{
    return m_type;
}

const string &ExprException::GetValue() const
{
    return m_value;
}

void ExprException::SetStart(string::size_type start)
{
    m_start = start;
}

void ExprException::SetEnd(string::size_type end)
{
    m_end = end;
}

string::size_type ExprException::GetStart() const
{
    return m_start;
}

string::size_type ExprException::GetEnd() const
{
    return m_end;
}

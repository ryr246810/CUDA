...
const Standard_GUID& OCAF_IVector::GetID() {
  static Standard_GUID anID("22D22E05-C69A-11d4-8F1A-0060B0EE18E8");
  return anID;
}
...
//=======================================================================
Handle(TDataStd_TreeNode) OCAF_IVector::MakeVector_FunctionNode( const Handle(TDataStd_TreeNode)& anObjectNode,
								 ...
								 TCollection_ExtendedString& theError)
{
  ...
  /*
  OCAF_IVector IVector(aFunctionNode);
  IVector.SetName("Vector function");
  IVector.SetType(theType);  
  */

  OCAF_IFunction aFunctionInterface(aFunctionNode);
  aFunctionInterface.SetName("Vector function");
...
//purpose  : Adds a line object to the document
//=======================================================================
Standard_Boolean OCAF_IVector::MakeVector_Execute( TCollection_ExtendedString& theError )
{
  if( myTreeNode.IsNull()) {
    theError = NOTDONE;
    return Standard_False;
  }
  // 5. setup a TFunction_Function's driver "aDriver" from OCAF_VectorDriver
  OCAF_VectorDriver aDriver;
...
//purpose  :
//=======================================================================
OCAF_IVector::OCAF_IVector(const Handle(TDataStd_TreeNode)& aTreeNode):OCAF_IFunction(aTreeNode)
{

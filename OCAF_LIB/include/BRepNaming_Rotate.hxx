...
#ifndef _BRepNaming_Rotate_HeaderFile
#define _BRepNaming_Rotate_HeaderFile
...
class BRepNaming_Rotate  : public BRepNaming_TopNaming {
...
public:
  ...
  // Methods PUBLIC
  // 
  Standard_EXPORT BRepNaming_Rotate();
  Standard_EXPORT BRepNaming_Rotate(const TDF_Label& ResultLabel);

...
#ifndef _BRepNaming_Revolution_HeaderFile
#define _BRepNaming_Revolution_HeaderFile
...
class BRepNaming_Revolution  : public BRepNaming_TopNaming {
...
public:
  ...
  // Methods PUBLIC
  // 
  Standard_EXPORT BRepNaming_Revolution();
  Standard_EXPORT BRepNaming_Revolution(const TDF_Label& ResultLabel);
  Standard_EXPORT   void Init(const TDF_Label& ResultLabel) ;
  Standard_EXPORT   void Load(TopoDS_Shape& aShape,const BRepNaming_TypeOfPrimitive3D TypeOfResult, const Standard_Integer aType) const;

...
#ifndef _BRepNaming_CosPeriodEdge_HeaderFile
#define _BRepNaming_CosPeriodEdge_HeaderFile
...
class BRepNaming_CosPeriodEdge  : public BRepNaming_TopNaming {
...
public:
  ...
  // Methods PUBLIC
  // 
  Standard_EXPORT BRepNaming_CosPeriodEdge();
  Standard_EXPORT BRepNaming_CosPeriodEdge(const TDF_Label& ResultLabel);

...
#ifndef _BRepNaming_Face_HeaderFile
#define _BRepNaming_Face_HeaderFile
...
class BRepNaming_Face  : public BRepNaming_TopNaming {
...
public:
  ...
  // Methods PUBLIC
  // 
  Standard_EXPORT BRepNaming_Face();
  Standard_EXPORT BRepNaming_Face(const TDF_Label& ResultLabel);
  Standard_EXPORT   void Init(const TDF_Label& ResultLabel) ;
  Standard_EXPORT   void Load(TopoDS_Face& aFace,const BRepNaming_TypeOfPrimitive3D TypeOfResult) const;

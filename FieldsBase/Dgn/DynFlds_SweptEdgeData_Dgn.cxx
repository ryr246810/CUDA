...
DynFlds_SweptEdgeData_Dgn::~DynFlds_SweptEdgeData_Dgn()
{
...
SetAttrib(const TxHierAttribSet& tha)
{
  ...
  if(tha.hasOption("dir")){
    ...
    cout<<"DynFlds_SweptEdgeData_Dgn::SetAttrib--------------error----dir"<<endl;
  }
  ...
  if(PhiNumber == 1)
  {
    ...
    cout<<"DynFlds_SweptEdgeData_Dgn::SetAttrib--------------error----Phi"<<endl;
  }
  ...
  if(tha.hasPrmVec("location")){
    ...
    if(theData.size()>=2){
      ...
      cout<<"DynFlds_SweptEdgeData_Dgn::SetAttrib--------------error----location"<<endl;
    }
    ...
    if(theindex.size()>=2){
      ...
      cout<<"DynFlds_SweptEdgeData_Dgn::SetAttrib--------------error----locationIndex-----1"<<endl;
    }
  }else{
    cout<<"DynFlds_SweptEdgeData_Dgn::SetAttrib--------------error----locationIndex-----2"<<endl;
  }
  ...
  if(tha.hasString("name")){
    ...
    cout<<"DynFlds_SweptEdgeData_Dgn::SetAttrib--------------error----name"<<endl;
  }

...
#ifndef _BRepNaming_Torus_HeaderFile
#define _BRepNaming_Torus_HeaderFile
...
class BRepNaming_Torus  : public BRepNaming_TopNaming {
...
//      }
 // Methods PUBLIC
 // 
Standard_EXPORT BRepNaming_Torus();
Standard_EXPORT BRepNaming_Torus(const TDF_Label& ResultLabel);

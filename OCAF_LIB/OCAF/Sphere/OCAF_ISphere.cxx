...
const Standard_GUID& OCAF_ISphere::GetID() {
  static Standard_GUID anID("22D22E53-C69A-11d4-8F1A-0060B0EE18E8");
  return anID;
}
...
//=======================================================================
Handle(TDataStd_TreeNode) OCAF_ISphere::MakeSphere_FunctionNode( const Handle(TDataStd_TreeNode)& anObjectNode,
								 ...
								 TCollection_ExtendedString& theError)
{
  ...
  /*
  OCAF_ISphere ISphere(aFunctionNode);
  ISphere.SetName("Sphere function");
  ISphere.SetType(theType);  
  */

  OCAF_IFunction aFunctionInterface(aFunctionNode);
  aFunctionInterface.SetName("Sphere function");
...
//purpose  : Adds a line object to the document
//=======================================================================
Standard_Boolean OCAF_ISphere::MakeSphere_Execute( TCollection_ExtendedString& theError )
{
  if( myTreeNode.IsNull()) {
    theError = NOTDONE;
    return Standard_False;
  }
  // 5. setup a TFunction_Function's driver "aDriver" from OCAF_SphereDriver
  OCAF_SphereDriver aDriver;
...
OCAF_ISphere::OCAF_ISphere(const Handle(TDataStd_TreeNode)& aTreeNode):OCAF_IFunction(aTreeNode)
{

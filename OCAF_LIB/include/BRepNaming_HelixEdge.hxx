...
#ifndef _BRepNaming_HelixEdge_HeaderFile
#define _BRepNaming_HelixEdge_HeaderFile
...
class BRepNaming_HelixEdge  : public BRepNaming_TopNaming {
...
public:
  ...
  // Methods PUBLIC
  // 
  Standard_EXPORT BRepNaming_HelixEdge();
  Standard_EXPORT BRepNaming_HelixEdge(const TDF_Label& ResultLabel);

...
#ifndef _BRepNaming_Polygon_HeaderFile
#define _BRepNaming_Polygon_HeaderFile
...
class BRepNaming_Polygon  : public BRepNaming_TopNaming {
...
public:
  ...
  // Methods PUBLIC
  // 
  Standard_EXPORT BRepNaming_Polygon();
  Standard_EXPORT BRepNaming_Polygon(const TDF_Label& ResultLabel);

#ifndef _SI_SC_Matrix_ElecFields_Cyl3D_HeaderFile
#define _SI_SC_Matrix_ElecFields_Cyl3D_HeaderFile
...
class SI_SC_Matrix_ElecFields_Cyl3D : public FieldsBase
{
public:
    SI_SC_Matrix_ElecFields_Cyl3D();
    SI_SC_Matrix_ElecFields_Cyl3D(const FieldsDefineCntr* theCntr,
        PhysDataDefineRule theRule);
    virtual ~SI_SC_Matrix_ElecFields_Cyl3D();
...
public:
    ...
    vector<GridEdgeData*>& GetEdgeDatas();
    vector<GridVertexData*>& GetVertexDatas();

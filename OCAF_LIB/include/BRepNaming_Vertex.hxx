...
#ifndef _BRepNaming_Vertex_HeaderFile
#define _BRepNaming_Vertex_HeaderFile
...
class BRepNaming_Vertex  : public BRepNaming_TopNaming {
...
public:
  ...
  // Methods PUBLIC
  // 
  Standard_EXPORT BRepNaming_Vertex();
  Standard_EXPORT BRepNaming_Vertex(const TDF_Label& ResultLabel);

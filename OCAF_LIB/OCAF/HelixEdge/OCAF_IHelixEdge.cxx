...
GetID() 
{
  static Standard_GUID anID("22D22E82-C69A-11d4-8F1A-0060B0EE18E8");
  return anID;
}
...
OCAF_IHelixEdge::
MakeHelixEdge_FunctionNode( const Handle(TDataStd_TreeNode)& anObjectNode,
		       ...
		       TCollection_ExtendedString& theError)
{
  ...
  /*
  OCAF_IHelixEdge IHelixEdge(aFunctionNode);
  IHelixEdge.SetName("Edge function");
  IHelixEdge.SetType(theType);  
  */

  OCAF_IFunction aFunctionInterface(aFunctionNode);
  aFunctionInterface.SetName("Helix function");
...
Standard_Boolean 
OCAF_IHelixEdge::
MakeHelixEdge_Execute( TCollection_ExtendedString& theError )
{
  if( myTreeNode.IsNull()) {
    theError = NOTDONE;
    return Standard_False;
  }
  // 5. setup a TFunction_Function's driver "aDriver" from OCAF_HelixEdgeDriver
  OCAF_HelixEdgeDriver aDriver;
...
//=======================================================================
OCAF_IHelixEdge::
OCAF_IHelixEdge(const Handle(TDataStd_TreeNode)& aTreeNode):OCAF_IFunction(aTreeNode)
{

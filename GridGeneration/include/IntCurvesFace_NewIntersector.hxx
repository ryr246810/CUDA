...
#define _IntCurvesFace_NewIntersector_HeaderFile
...
class IntCurvesFace_NewIntersector  {
public:
  ...
  Standard_EXPORT   IntCurvesFace_NewIntersector(const TopoDS_Face& F,const Standard_Real aTol);
...
//============================================================================
inline Standard_Boolean IntCurvesFace_NewIntersector::IsDone() const { 
  return(done);
}
//============================================================================
inline Standard_Integer IntCurvesFace_NewIntersector::NbPnt() const { 
  return(nbpnt);
}
//============================================================================
inline const gp_Pnt& IntCurvesFace_NewIntersector::Pnt(const Standard_Integer i ) const { 
  return(SeqPnt.Value(i).Pnt()); 
}
//============================================================================
inline Standard_Real IntCurvesFace_NewIntersector::UParameter(const Standard_Integer i) const { 
  return(SeqPnt.Value(i).U()); 
}
//============================================================================
inline Standard_Real IntCurvesFace_NewIntersector::VParameter(const Standard_Integer i) const { 
  return(SeqPnt.Value(i).V()); 
}
//============================================================================
inline Standard_Real IntCurvesFace_NewIntersector::WParameter(const Standard_Integer i) const { 
  return(SeqPnt.Value(i).W()); 
}
//============================================================================
inline IntCurveSurface_TransitionOnCurve IntCurvesFace_NewIntersector::Transition(const Standard_Integer i) const { 
  return(SeqPnt.Value(i).Transition()); 
}
//============================================================================
inline TopAbs_State IntCurvesFace_NewIntersector::State(const Standard_Integer i) const { 
  return (mySeqState.Value(i) == 0) ? TopAbs_IN : TopAbs_ON;
}
//============================================================================
inline const TopoDS_Face&  IntCurvesFace_NewIntersector::Face() const { 
  return(face);
}
//============================================================================

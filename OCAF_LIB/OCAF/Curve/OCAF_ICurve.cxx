...
const Standard_GUID& OCAF_ICurve::GetID() {
  static Standard_GUID anID("22D22E84-C69A-11d4-8F1A-0060B0EE18E8");
  return anID;
}
...
//=======================================================================
Handle(TDataStd_TreeNode) OCAF_ICurve::MakeCurve_FunctionNode( const Handle(TDataStd_TreeNode)& anObjectNode,
							       ...
							       TCollection_ExtendedString& theError)
{
  ...
  aFunctionInterface.SetName("Curve function");
...
//purpose  : Adds a line object to the document
//=======================================================================
Standard_Boolean OCAF_ICurve::MakeCurve_Execute( TCollection_ExtendedString& theError )
{
  if( myTreeNode.IsNull()) {
    theError = NOTDONE;
    return Standard_False;
  }
  // 5. setup a TFunction_Function's driver "aDriver" from OCAF_CurveDriver
  OCAF_CurveDriver aDriver;
...
//purpose  :
//=======================================================================
OCAF_ICurve::OCAF_ICurve(const Handle(TDataStd_TreeNode)& aTreeNode):OCAF_IFunction(aTreeNode)
{

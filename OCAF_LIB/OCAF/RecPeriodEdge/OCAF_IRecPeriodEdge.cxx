...
GetID() 
{
  static Standard_GUID anID("22D22E81-C69A-11d4-8F1A-0060B0EE18E8");
  return anID;
}
...
OCAF_IRecPeriodEdge::
MakeRecPeriodEdge_FunctionNode( const Handle(TDataStd_TreeNode)& anObjectNode,
				...
				TCollection_ExtendedString& theError)
{
  ...
  /*
  OCAF_IRecPeriodEdge IRecPeriodEdge(aFunctionNode);
  IRecPeriodEdge.SetName("Edge function");
  IRecPeriodEdge.SetType(theType);  
  */

  OCAF_IFunction aFunctionInterface(aFunctionNode);
  aFunctionInterface.SetName("Rec Period Edge function");
...
Standard_Boolean 
OCAF_IRecPeriodEdge::
MakeRecPeriodEdge_Execute( TCollection_ExtendedString& theError )
{
  if( myTreeNode.IsNull()) {
    theError = NOTDONE;
    return Standard_False;
  }
  // 5. setup a TFunction_Function's driver "aDriver" from OCAF_RecPeriodEdgeDriver
  OCAF_RecPeriodEdgeDriver aDriver;
...
//=======================================================================
OCAF_IRecPeriodEdge::
OCAF_IRecPeriodEdge(const Handle(TDataStd_TreeNode)& aTreeNode):OCAF_IFunction(aTreeNode)
{

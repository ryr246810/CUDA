...
#ifndef _BRepNaming_Selection_HeaderFile
#define _BRepNaming_Selection_HeaderFile
...
class BRepNaming_Selection  : public BRepNaming_TopNaming {
...
public:
  ...
  // Methods PUBLIC
  // 
  Standard_EXPORT   BRepNaming_Selection();
  Standard_EXPORT   BRepNaming_Selection(const TDF_Label& ResultLabel);
  Standard_EXPORT   void Init(const TDF_Label& ResultLabel) ;
  Standard_EXPORT   void Load(const TopoDS_Shape& aShape,const BRepNaming_TypeOfPrimitive3D TypeOfResult ) const;

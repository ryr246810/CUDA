...
#ifndef _BRepNaming_Cone_HeaderFile
#define _BRepNaming_Cone_HeaderFile
...
class BRepNaming_Cone  : public BRepNaming_TopNaming {
...
//      }
 // Methods PUBLIC
 // 
Standard_EXPORT BRepNaming_Cone();
Standard_EXPORT BRepNaming_Cone(const TDF_Label& ResultLabel);

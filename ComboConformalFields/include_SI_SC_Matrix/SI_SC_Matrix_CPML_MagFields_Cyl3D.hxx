#ifndef _SI_SC_Matrix_CPML_MagFields_Cyl3D_HeaderFile
#define _SI_SC_Matrix_CPML_MagFields_Cyl3D_HeaderFile
...
class SI_SC_Matrix_CPML_MagFields_Cyl3D : public SI_SC_Matrix_MagFields_Cyl3D
{
public:
    SI_SC_Matrix_CPML_MagFields_Cyl3D();
    SI_SC_Matrix_CPML_MagFields_Cyl3D(const FieldsDefineCntr* theCntr);

    virtual ~SI_SC_Matrix_CPML_MagFields_Cyl3D();

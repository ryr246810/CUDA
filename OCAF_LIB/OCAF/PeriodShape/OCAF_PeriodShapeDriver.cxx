...
//purpose  :
//=======================================================================
Standard_Integer OCAF_PeriodShapeDriver::Execute(Handle(TFunction_Logbook)& theLogbook) const 
{
  ...
  TopLoc_Location orgLoc = aContext.Location();
  ...
  for(Standard_Integer i=1; i<periodNum; i++){
    ...
    TopoDS_Shape aNewShape = aContext.Located(aLocRes);
  ...
  TopoDS_Shape currShape = mkFuse.Shape();

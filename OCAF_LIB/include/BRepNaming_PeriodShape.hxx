...
#ifndef _BRepNaming_PeriodShape_HeaderFile
#define _BRepNaming_PeriodShape_HeaderFile
...
class BRepNaming_PeriodShape  : public BRepNaming_TopNaming {
...
public:
  ...
  // Methods PUBLIC
  // 
  Standard_EXPORT BRepNaming_PeriodShape();
  Standard_EXPORT BRepNaming_PeriodShape(const TDF_Label& ResultLabel);

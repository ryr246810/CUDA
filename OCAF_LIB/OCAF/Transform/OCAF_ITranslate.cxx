...
const Standard_GUID& OCAF_ITranslate::GetID() {
  static Standard_GUID anID("22D22E64-C69A-11d4-8F1A-0060B0EE18E8");
  return anID;
}
...
//=======================================================================
Handle(TDataStd_TreeNode) OCAF_ITranslate::MakeTranslate_FunctionNode( const Handle(TDataStd_TreeNode)& theNode,
								       ...
								       TCollection_ExtendedString& theError)
{
  ...
  aFunctionInterface.SetName("Translate function");
...
//purpose  : Adds a line object to the document
//=======================================================================
Standard_Boolean OCAF_ITranslate::MakeTranslate_Execute( TCollection_ExtendedString& theError )
{
  if( myTreeNode.IsNull()) {
    theError = NOTDONE;
    return Standard_False;
  }
  // 5. setup a TFunction_Function's driver "aDriver" from OCAF_TranslateDriver
  OCAF_TranslateDriver aDriver;
...
//purpose  :
//=======================================================================
OCAF_ITranslate::OCAF_ITranslate(const Handle(TDataStd_TreeNode)& aTreeNode)
...
//=======================================================================
void OCAF_ITranslate::SetMoveAttach(Standard_Boolean theType)
{
...
//=======================================================================
Standard_Boolean OCAF_ITranslate::GetMoveAttach() 
{
  TDF_Label L = GetEntry().FindChild(ARGUMENTS_TAG);
  Handle(TDataStd_Integer) anInt;  
  TDF_Label aLabel = L.FindChild(TRANSLATE_ARG_MOVE);
...
//=======================================================================
void OCAF_ITranslate::SetCopyMode(Standard_Boolean theType)
{
  TDF_Label L = GetEntry().FindChild(ARGUMENTS_TAG);
  Handle(TDataStd_Integer) anInt;
  Standard_Integer aType = theType ? 1 : 0;
...
//=======================================================================
Standard_Boolean OCAF_ITranslate::GetCopyMode() 
{
  TDF_Label L = GetEntry().FindChild(ARGUMENTS_TAG);
  Handle(TDataStd_Integer) anInt;  
  TDF_Label aLabel = L.FindChild(TRANSLATE_ARG_COPYMODE);

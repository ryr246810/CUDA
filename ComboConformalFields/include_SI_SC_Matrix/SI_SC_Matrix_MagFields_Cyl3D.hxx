#ifndef _SI_SC_Matrix_MagFields_Cyl3D_HeaderFile
#define _SI_SC_Matrix_MagFields_Cyl3D_HeaderFile

#include "FieldsBase.hxx"
#include "FaceMagFldsBase_Cyl3D.hxx"
#include "SweptFaceMagFldsBase_Cyl3D.hxx"

class SI_SC_Matrix_MagFields_Cyl3D : public FieldsBase
{
public:
    SI_SC_Matrix_MagFields_Cyl3D();
    SI_SC_Matrix_MagFields_Cyl3D(const FieldsDefineCntr* theCntr,
        PhysDataDefineRule theRule);
    virtual ~SI_SC_Matrix_MagFields_Cyl3D();

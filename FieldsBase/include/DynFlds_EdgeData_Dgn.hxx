#ifndef _DynFlds_EdgeData_Dgn_HeaderFile
#define _DynFlds_EdgeData_Dgn_HeaderFile

#include <FieldsDgnBase.hxx>

class DynFlds_EdgeData_Dgn : public FieldsDgnBase
{
public:

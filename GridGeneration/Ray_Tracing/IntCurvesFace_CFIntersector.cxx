...
GeomAbs_SurfaceType IntCurvesFace_CFIntersector::SurfaceType() const { 
  return(Adaptor3d_HSurfaceTool::GetType(Hsurface));
}
 
//============================================================================
IntCurvesFace_CFIntersector::IntCurvesFace_CFIntersector()
  : Tol(1e-10), done(Standard_False),nbpnt(0)
{
  Hsurface = NULL;
  myTopolTool = NULL;
}
...
//============================================================================
void IntCurvesFace_CFIntersector::Load(const TopoDS_Face& Face, const Standard_Real aTol)
{ 
  Tol = aTol;
  done = Standard_False;
  nbpnt = 0;
...
void IntCurvesFace_CFIntersector::InternalCall(const IntCurveSurface_HInter &HICS, const Standard_Real parinf, const Standard_Real parsup) {
  if(HICS.IsDone()) {
...
void IntCurvesFace_CFIntersector::Perform(const gp_Lin& L,const Standard_Real ParMin,const Standard_Real ParMax) { 
  done = Standard_True;
  SeqPnt.Clear();
  mySeqState.Clear();
  nbpnt = 0;
...
//============================================================================
void IntCurvesFace_CFIntersector::Perform(const Handle(Adaptor3d_HCurve)& HCu,const Standard_Real ParMin,const Standard_Real ParMax) { 
  done = Standard_True;
  SeqPnt.Clear();
  mySeqState.Clear();
  nbpnt = 0;
...
TopAbs_State IntCurvesFace_CFIntersector::ClassifyUVPoint(const gp_Pnt2d& Puv) const { 
...
//============================================================================
void IntCurvesFace_CFIntersector::Destroy() { 
}

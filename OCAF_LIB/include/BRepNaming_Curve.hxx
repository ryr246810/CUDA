...
#ifndef _BRepNaming_Curve_HeaderFile
#define _BRepNaming_Curve_HeaderFile
...
class BRepNaming_Curve  : public BRepNaming_TopNaming {
...
//      }
 // Methods PUBLIC
 // 
Standard_EXPORT BRepNaming_Curve();
Standard_EXPORT BRepNaming_Curve(const TDF_Label& ResultLabel);
